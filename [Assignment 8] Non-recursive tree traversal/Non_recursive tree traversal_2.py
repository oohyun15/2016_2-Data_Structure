           ...
           # print("\n\tsize",stack.size())
            ...
            if node.isExternal(): # X X
                ...
                while(1):
                    temp = stack.pop()
                    yield temp
                    if temp.isRoot() or (temp._left != None and temp._right != None):
                        break
...
if __name__ ==  "__main__":
      ...
      root.getLeft().getRight().addRight( '9')
      root.getLeft().getRight().getRight().addLeft( '10')
      root.getLeft().getRight().getRight().addRight( '11')
      ...
      print( " \n ")
       ...
       # 1 2 4 5 9 10 11 3 6 8 7   3점
      print( " \n Non-Recursive Preorder Traversal")
      for p  in root.preorder_nonrecursive():
          print(p.getElement() ,  end= " ")
      print( " \n ")
  
       # 4 10 11 9 5 2 8 6 7 3 1   4점
